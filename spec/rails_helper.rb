...
RSpec.configure do |config|
  ...
  # instead of true.
  # Transactional fixtures are replaced by DatabaseCleaner (spec/support/database_cleaner.rb),
  # which supports non-transactional strategies for js/system specs.
